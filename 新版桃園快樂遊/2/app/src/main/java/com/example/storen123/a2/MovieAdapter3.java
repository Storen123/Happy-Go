...
public class MovieAdapter3 extends  BaseAdapter{
    ...
    public MovieAdapter3(Context context, ArrayList <Movie> movies) {
    ...
    public View getView(int position,View convertView,ViewGroup parent) {
        ...
        View v =inflater.inflate (R.layout.activity_dac2,null);
        ImageView pic = v.findViewById (R.id.pic1);
        TextView name =v.findViewById (R.id.name1);
        TextView date =v.findViewById (R.id.date1);
        TextView intro =v.findViewById (R.id.intro1);
